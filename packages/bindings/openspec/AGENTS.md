...
8. **Testing workflow** - Create `tests.md`, enumerate unit test options, add unit tests under project root `__tests__/<change-id>/`, add unit test tasks to `tasks.md`, and record pass/fail (if failing, re-evaluate requirements)
